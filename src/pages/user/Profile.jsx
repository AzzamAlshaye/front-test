...
function Profile() {
  ...
  const handleSave = () => {
    ...
    userService.updateSelf(updateData)
      .then((res) => {
        setUser(res);
        setPassword("");
  ...
  const handleSaveEdit = () => {
    pinService.update(editingPin.id, editForm)
      .then((updated) => {
        setMemories((prev) =>
        ...
        <section className="bg-white rounded-xl shadow-lg p-8 mb-10">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex flex-col">
              <label className="text-xs text-gray-500 mb-1 uppercase tracking-wide">Name</label>
              <input
                type="text"
                value={name}
            ...
            <div className="flex flex-col">
              <label className="text-xs text-gray-500 mb-1 uppercase tracking-wide">Email</label>
              <input
                type="email"
                value={email}
            ...
            <div className="flex flex-col relative">
              <label className="text-xs text-gray-500 mb-1 uppercase tracking-wide">Password</label>
              <input
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
              <div className="bg-white p-6 rounded-lg shadow-xl w-full max-w-md">
                ...
                <div className="flex justify-end gap-2">
                  <button onClick={() => setEditingPin(null)} className="px-4 py-2 bg-gray-300 rounded">
                    Cancel
                  </button>
